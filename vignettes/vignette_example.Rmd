...
Create scenarios and arr_scenarios
``` {r scenarios}
scenarios <- create_scenarios("scenarios", arrivals_all, capacity, losA, init_conds)
arr_scenarios <- create_scenarios("arr_scenarios", arrivals_all, capacity, losA, init_conds)
```
